...
export function Landing({ go, boundary }: Props) {
  return (
    <>
      <section className="hero" aria-label="Silent Bell">
        <div className="hero-visual" aria-hidden="true">
          ...
          <div className="bell-stage">
            ...
            >
              ...
              />
              <path
                d="M88 219h64c0 18-14 33-32 33s-32-15-32-33z"
                fill="#c5d0c9"
              />
              <circle cx="120" cy="48" r="7" fill="#c9a227" />
              <path
                d="M155 72l28 28M183 72l-28 28"
                stroke="#c9a227"
                strokeWidth="8"
                strokeLinecap="round"
              />
        ...
        <div className="hero-copy">
          ...
          <p className="hero-support">
            Prove you belong on this semester’s roll - without ever naming which
            leaf you are.
          </p>
      ...
      <section className="section trap-section" aria-labelledby="trap-title">
        <div className="section-inner">
          <Reveal>
            ...
            <h2 id="trap-title">
              Campuses are forced to choose the wrong kind of silence.
            </h2>
            <p className="section-lead story-lead">
              Students who fear retaliation stay quiet. Forms that accept anyone
              drown real harm in spam. Equity cells inherit both failures - and
              none of the trust.
            </p>
          </Reveal>
          <div className="trap-grid">
            <Reveal className="trap-col" delay={80}>
              ...
              <p className="trap-outcome">
                Retaliation risk. Juniors never file.
              </p>
            </Reveal>
            ...
            <Reveal className="trap-col" delay={160}>
              ...
              <p className="trap-outcome">
                Outsiders spam. Committee cannot trust a word.
              </p>
            </Reveal>
          </div>
        </div>
        ...
        <div className="section-inner">
          <Reveal>
            ...
            <h2 id="solution-title">
              Silent Bell breaks the trap with one proof.
            </h2>
            <p className="section-lead story-lead">
              A student proves membership in the semester roster. Midnight
              accepts the filing. The ledger never learns which student. The
              story stays sealed for the committee alone.
            </p>
          </Reveal>
          ...
          <div className="solution-visual-row">
            <Reveal className="photo-frame" delay={60}>
              ...
              <p className="photo-caption">
                Sealed on purpose - plaintext never hits the ledger.
              </p>
            </Reveal>
          ...
          <div
            ...
            aria-label="How Silent Bell proves enrolment privately"
          >
          ...
          <Reveal className="promise-strip" delay={100}>
            ...
            <p>
              <strong>Duplicates fail.</strong> Same category, same semester →
              blocked.
            </p>
            <p>
              <strong>Committee reads the case.</strong> Not the silent
              identity.
            </p>
          </Reveal>
        </div>
      ...
      <section
        className="section boundary-section"
          ...
          <ol className="role-flow">
            <Reveal as="li" delay={60}>
              ...
              <div>
                <h3>Registrar</h3>
                <p>
                  Publishes the semester roll as hashed leaves. Freezes the
                  epoch when the term turns.
                </p>
              </div>
            </Reveal>
            <Reveal as="li" delay={120}>
              ...
              <div>
                <h3>Student</h3>
                <p>
                  Rings silently - or takes the named emergency rail when danger
                  requires a handle.
                </p>
              </div>
            </Reveal>
            <Reveal as="li" delay={180}>
              ...
              <div>
                <h3>Committee</h3>
                <p>
                  Unlocks on device, decrypts the sealed case, acts - without
                  learning which silent leaf filed.
                </p>
              </div>
            </Reveal>
          </ol>
      ...
      <footer className="site-footer">
        <div className="site-footer-inner">
          <div className="footer-brand">
            ...
            <p>
              Anonymous campus intake with Compact membership proofs. Built on
              Midnight.
            </p>
          </div>
